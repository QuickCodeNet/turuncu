...
namespace QuickCode.Turuncu.UserManagerModule.Persistence.Migrations
{
    ...
    [Migration("20241029021316_AutoMigration_638657647594865054")]
    partial class AutoMigration_638657647594865054
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.AspNetRoleClaims", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.AspNetRoles", b =>
                {
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.AspNetUserClaims", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.AspNetUserLogins", b =>
                {
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.AspNetUserRoles", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.AspNetUserTokens", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.AspNetUsers", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.ColumnTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.PortalMenus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.PortalPermissionGroups", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.PortalPermissionTypes", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.PortalPermissions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.RefreshTokens", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.TableComboboxSettings", b =>
                {
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.ApiPermissionGroups", b =>
                {
                    b.HasOne("QuickCode.Turuncu.UserManagerModule.Domain.Entities.ApiMethodDefinitions", "ApiMethodDefinition")
                        .WithMany("ApiPermissionGroups")
                        .HasForeignKey("ApiMethodDefinitionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("QuickCode.Turuncu.UserManagerModule.Domain.Entities.PermissionGroups", "PermissionGroup")
                        .WithMany("ApiPermissionGroups")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.AspNetRoleClaims", b =>
                {
                    b.HasOne("QuickCode.Turuncu.UserManagerModule.Domain.Entities.AspNetRoles", "Role")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.AspNetUserClaims", b =>
                {
                    b.HasOne("QuickCode.Turuncu.UserManagerModule.Domain.Entities.AspNetUsers", "User")
            ...
            modelBuilder.Entity("QuickCode.Turuncu.UserManagerModule.Domain.Entities.PortalPermissionGroups", b =>
                {
                    ...
                    b.HasOne("QuickCode.Turuncu.UserManagerModule.Domain.Entities.PortalPermissions", "PortalPermission")
                        .WithMany("PortalPermissionGroups")
                        .HasForeignKey("PortalPermissionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("QuickCode.Turuncu.UserManagerModule.Domain.Entities.PortalPermissionTypes", "PortalPermissionType")
                        .WithMany("PortalPermissionGroups")
